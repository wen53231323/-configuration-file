$(function(){
    ...
    var musicImgsData = [
    		'/music/Azure/Azure.png',
    		'/music/FeelingTheRain/FeelingTheRain.png',
    		'/music/Hanabi/Hanabi.png',
    		'/music/Sia-DuskTillDawn/Sia-DuskTillDawn.png',
    		'/music/U&I/U&I.png',
    		'/music/海の形/海の形.png',
    		'/music/我的歌声里/我的歌声里.png',
    		'/music/大家一起喜羊羊/大家一起喜羊羊.png',
    		]
    	// 歌曲名数组
        var musicNameData = [
    		'Azure',
    	...
    	// 歌曲mp3数组
        var musicUrls=[
    		'/music/Azure/Azure.mp3',
    		'/music/FeelingTheRain/Feeling The Rain.mp3',
    		'/music/Hanabi/Hanabi.mp3',
    		'/music/Sia-DuskTillDawn/Sia-Dusk Till Dawn.mp3',
    		'/music/U&I/U & I.mp3',
    		'/music/海の形/海の形.mp3',
    		'/music/我的歌声里/我的歌声里.mp3',
    		'/music/大家一起喜羊羊/大家一起喜羊羊.mp3',
    		];
